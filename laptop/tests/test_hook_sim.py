...
Usage:
  python test_hook_sim.py stop      # simulate task completion (polls 10s)
  python test_hook_sim.py perm      # simulate PermissionRequest (polls ~110s)
...
def _make_transcript(messages: list) -> str:
    ...
    with os.fdopen(fd, "w", encoding="utf-8") as fh:
        for msg in messages:
            ...
            envelope = {"type": role, "message": msg}
